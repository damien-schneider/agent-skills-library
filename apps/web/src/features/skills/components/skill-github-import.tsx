...
import type { ParsedSkill } from "@skills-agent-library/skills-core/skill-parser";
import { validateParsedSkill } from "@skills-agent-library/skills-core/skill-parser";
